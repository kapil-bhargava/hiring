                  ...
                  >
                    ...
                    <td className="px-5 py-4">
                      <div className="flex gap-2">
                        ...
                        <img src={import.meta.env.VITE_APP_API + applicant.candidateId?.profilePic?.fileUrl || avtar} alt={applicant.snapshot.name || "Profile"} className="w-10 h-10 rounded-full object-cover mb-2" />
                        <div className="flex flex-col">
                          <span className="font-medium text-gray-800">
                            {applicant.snapshot.name || "Unknown Candidate"}
                          </span>
                          <span className="text-xs text-gray-500">
                            {applicant.snapshot.email || "Unknown Candidate Email"}
                          </span>
                        </div>
                      </div>
                    </td>
